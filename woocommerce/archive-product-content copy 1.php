...
if ( ( function_exists( 'woocommerce_product_loop' ) && woocommerce_product_loop() ) || ( ! function_exists( 'woocommerce_product_loop' ) && have_posts() ) ) {
	...
	if ( ! $builder_id ) {
		...
		echo '<h4>Report Description:</h4>';
		echo  "<pre>";
		//print_r($term);
		echo  "</pre>";
		echo $term->description;
		echo "<hr>";
		echo '<div class="row pt-20 pb-20">';
		echo '<div class="col-md-3">';
		
			echo 'No. of Reports: ' . ij_get_productcat_postcount($term->term_id);
		echo '</div>';
		echo '<div class="col-md-6">';
			echo 'Report Category Name  : ' . $term->name;
		
		echo '</div>';
		
		echo '<div class="col-md-3">';echo '</div>';
		echo '</div>';
