...
<li>
	...
	<div class="product-details   <?php echo CheckReportScope(  $product->get_id() ); ?>">
		...
		//productprice($product->get_id()); //porto_filter_output( $product->get_price_html() ); // PHPCS:Ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</div>
